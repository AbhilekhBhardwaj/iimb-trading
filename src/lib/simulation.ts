...
// Formatting helpers
// ---------------------------------------------------------------------------
// Defined in ./format so that pure, non-React code can import them without
// pulling in this module's `window`-dependent hook. Re-exported here because
// several call sites already import them from './simulation'.

export { inr, inrSigned, pct, usd, usdAxis } from './format'
